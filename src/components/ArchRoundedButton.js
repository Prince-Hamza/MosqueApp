...
class ArchRoundedButton extends Component {
  render() {
    ...
    if (Platform.OS === 'ios') {
      return (
        <View style={iosStyle.btnView}>
          <Button rounded light style={iosStyle.btnRounded} onPress={
            this.props.onpress ? this.props.onpress() : () => navigation.navigate('MainStack')
            // alert('hello')
          }>
    ...
    return (
      <View style={iosStyle.btnView}>
        <TouchableOpacity style={st.btnRounded} onPress={
          this.props.onpress ? this.props.onpress : () => navigation.navigate('MainStack')
